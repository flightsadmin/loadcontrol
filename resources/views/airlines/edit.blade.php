            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $airline->name) }}"
                            required>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="base" id="base" class="form-control" value="{{ old('base', $airline->base) }}"
                            required>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="settings[passenger_weights][female]" id="passenger_weight_female" class="form-control"
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="settings[passenger_weights][infant]" id="passenger_weight_infant" class="form-control"
