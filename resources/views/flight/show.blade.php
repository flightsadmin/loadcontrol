                ...
                <div class="card-body">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <p class="card-text"><strong>Registration:</strong> {{ $flight->registration->registration }}
                                    <a href="{{ route('registrations.edit', $flight->registration->id) }}" class="bi-pencil-square text-danger"></a>
                                </p>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5>Loaded Cargo</h5>
                            <a href="{{ route('flights.cargos.create', $flight->id) }}" class="btn btn-primary btn-sm bi-plus-lg"> Add Deadload</a>
                        </div>
                        <ul class="list-group">
