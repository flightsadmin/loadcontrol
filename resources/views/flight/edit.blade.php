...
@section('content')
    <h1 class="mb-4">Edit Flight: {{ $flight->flight_number }}</h1>
    <form action="{{ route('flights.update', $flight->id) }}" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="datetime-local" id="arrival" name="arrival" class="form-control" value="{{ old('arrival', $flight->arrival) }}"
                    required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" id="origin" name="origin" class="form-control" value="{{ old('origin', $flight->origin) }}" required>
            </div>
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" id="airline" name="airline" class="form-control" value="{{ old('airline', $flight->airline) }}"
                    required>
            </div>
            <div class="col-md-6">
                ...
                <select id="flight_type" name="flight_type" class="form-select" required>
                    ...
                    <option value="International" {{ $flight->flight_type == 'International' ? 'selected' : '' }}>International</option>
                </select>
            </div>
        </div>
