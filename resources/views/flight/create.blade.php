                    ...
                    <form action="{{ route('flights.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select id="registration_id" name="registration_id"
                                    class="form-select @error('registration_id') is-invalid @enderror" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="airline" name="airline" class="form-control @error('airline') is-invalid @enderror"
