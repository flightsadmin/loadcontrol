<div class="mb-4">
    ...
    <div class="table-responsive">
        <table class="table table-sm">
            ...
            <tbody>
                <tr>
                    <td colspan="{{ $isEditable ? 5 : 4 }}" class="text-center fw-bold">
                        Deck Crew
                    </td>
                </tr>
                @forelse ($deck_crew as $index => $value)
                    <tr>
                        ...
                        @else
                            ...
                            <td>{{ $value['arm'] }}</td>
                            <td>{{ $value['index_per_kg'] ?? 0 }}</td>
                        @endif
                    </tr>
                @empty
                    <tr>
                        <td colspan="{{ $isEditable ? 5 : 4 }}" class="text-center">No Deck Crew for this flight yet</td>
                    </tr>
                @endforelse
            </tbody>
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="{{ $isEditable ? 5 : 4 }}" class="text-center">
                            No Cabin Crew for this aircraft type yet
                        </td>
                    </tr>
                @endforelse
            </tbody>
